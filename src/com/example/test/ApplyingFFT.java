...
public class ApplyingFFT {
	  ...
	  private RealDoubeFFT spectrumAmpFFT;
	  ...
	  private void init(int fftlen, int sampleRate, int minFeedSize, String wndName) {
	    ...
	    spectrumAmpFFT   = new RealDoubeFFT(spectrumAmpIn.length);
	  ...
	  public ApplyingFFT(int fftlen, int sampleRate, int minFeedSize, String wndName) {
	    init(fftlen, sampleRate, minFeedSize, wndName);
	  }

	  public ApplyingFFT(int fftlen, int sampleRate, String wndName) {
